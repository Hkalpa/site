...
<?php if ( $the_query ) { ?>
	...
	<?php if ( $the_query->max_num_pages > 1 ) : ?>
		...
		<div class="page-pagination pagination-margin clearfix">
			<p class="clearfix">
				<span class="fl prev-pagination"><?php next_posts_link( esc_html__( '&larr; Older posts', 'sohohotel' ), $the_query->max_num_pages ); ?></span>
				<span class="fr next-pagination"><?php previous_posts_link( esc_html__( 'Newer posts &rarr;', 'sohohotel' ), $the_query->max_num_pages ); ?></span>	
			</p>
		</div>
