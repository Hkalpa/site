...
if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . esc_html__( 'Previous tab', 'sohohotel' ) . '">' . esc_html__( 'Previous tab', 'sohohotel' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . esc_html__( 'Next tab', 'sohohotel' ) . '">' . esc_html__( 'Next tab', 'sohohotel' ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
