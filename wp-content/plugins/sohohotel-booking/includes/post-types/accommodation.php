...
function accommodation_taxonomy() {	
    register_taxonomy( __('accommodation-categories','sohohotel_booking'), 'accommodation', array( 'hierarchical' => true, 'label' => __('Hotel','sohohotel_booking'), 'query_var' => true, 'rewrite' => true ) );
}
