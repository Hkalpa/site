...
<div class="outer-tabs clearfix">
	...
	<div id="price-per-night">
		...
		<p class="msg-guide"><?php esc_html_e('You are inside the "Pricing Per Night" tab, all prices added here will be applied when a guest books for 6 nights or less','sohohotel_booking'); ?></p>
		...
		<div class="inner-tabs clearfix">
			...
			<div class="tab-content-wrapper clearfix">
				...
				<div id="general-pricing" class="clearfix">
					...
					<div class="sohohotel_booking-field-wrapper clearfix">
						<div class="sohohotel_booking-one-third">Per Child (<?php echo $sohohotel_data['currency_unit']; ?>)</div>
	...
	<div id="price-per-week">
		...
		<p class="msg-guide"><?php esc_html_e('You are inside the "Pricing Per Week" tab, all prices added here will be applied when a guest books for 7 nights or more','sohohotel_booking'); ?></p>
	...
	<div id="price-per-month">
		...
		<p class="msg-guide"><?php esc_html_e('You are inside the "Pricing Per Month" tab, all prices added here will be applied when a guest books for 28 nights or more','sohohotel_booking'); ?></p>
