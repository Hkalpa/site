...
<div class="sohohotel_booking-field-wrapper clearfix">
	...
	<div class="sohohotel_booking-two-thirds">
		...
		<input class="sh-required-field datepicker blocked_check_in" type="text" name="_blocked_dates_meta[from]" value="<?php if(!empty($blocked_dates_meta['from'])) echo $blocked_dates_meta['from']; ?>" />
		
		<hr class="space3" />
		
		<label for="blocked_dates_discount_type_flat"><?php esc_html_e('To','sohohotel_booking'); ?></label>
		<input class="sh-required-field datepicker blocked_check_out" type="text" name="_blocked_dates_meta[to]" value="<?php if(!empty($blocked_dates_meta['to'])) echo $blocked_dates_meta['to']; ?>" />
