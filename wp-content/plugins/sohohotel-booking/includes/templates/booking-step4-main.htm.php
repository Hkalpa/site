...
sh_send_booking_emails($_POST,$booking_id);
...
// Stripe
	...
	<form name="stripe_form" action="<?php echo $sohohotel_data["booking_page_url"]; ?>" method="post">
		<input type="hidden" name="stripe_payment" value="true" />
		<input type="hidden" name="price" value="<?php echo $_SESSION['sh_booking_data']['total_booking_deposit_price']; ?>" />
