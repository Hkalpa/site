...
<div class="price-details <?php if ( $sohohotel_data['deposit_percentage'] == '100' ) {echo 'no-deposit';} ?>">
	...
	<?php if( $sohohotel_data['tax-rate'] != 'none' && is_numeric($sohohotel_data['tax-rate']) ) { ?>
...
$sh_booking_data["total_booking_price"] = $total_booking_price_2;
$sh_booking_data["total_booking_deposit_price"] = $deposit_price;
...
<button class="edit-booking-button" name="edit_booking_button" type="submit"><?php esc_html_e('Edit Booking','sohohotel_booking'); ?></button>