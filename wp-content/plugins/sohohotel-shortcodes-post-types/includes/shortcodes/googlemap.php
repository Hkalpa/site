...
function googlemap_shortcode( $atts, $content = null ) {
	...
	$defaults = array(
			...
			'latitude' => '40.703316',
			'longitude' => '-73.988145',
			'marker_content' => 'sohohotel Car Rental',
			'map_color' => '#b19f6a',
			'marker_color' => '#b19f6a'
	);
	...
	if ($marker_content == '') {$marker_content = 'sohohotel Car Rental';}
	if ($map_color == '') {$map_color = '#b19f6a';}
	if ($marker_color == '') {$marker_color = '#b19f6a';} ?>
	...
	<?php } else {
		echo '<div class="msg fail">' . esc_html__('Please enter a valid Google Map API key in the theme options "General" section','sohohotel') . '</div>';
	} ?>
